...
export const Hero = () => {
  const handleDownloadCV = () => {
    ...
    link.href = '/cv_kagou_dicko.pdf';
    link.download = 'Kagou-DICKO-CV.pdf';
    link.click();
  };
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                Garantir la{" "}
                <span className="text-primary glow-text">qualité</span>
                <br />
                et la sécurité
                <br />
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Bonjour, je suis Kagou DICKO — ingénieur en industrie
                agroalimentaire spécialisé en HACCP, ISO 22000 et IFS Food.
                Je contribue à la mise en conformité et à l'amélioration
                continue des systèmes qualité et sécurité alimentaire.
              </p>
            </div>
